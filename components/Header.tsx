        ...
        <div className="max-w-[1750px] mx-auto flex flex-col xl:flex-row items-stretch xl:items-center justify-between gap-2.5">
          ...
          <div className="flex items-center justify-between gap-3 shrink-0">
            <div className="flex items-center gap-2.5">
              <div className="relative flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-gradient-to-br from-cyan-500 via-blue-600 to-slate-900 shadow-md shadow-cyan-500/20 ring-1 ring-white/20 shrink-0">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5">
                  <span className="text-[9px] font-bold tracking-wider uppercase px-1.5 py-0.2 rounded bg-cyan-950 border border-cyan-800 text-cyan-400">
                    GALVA AI BIBLE
                  </span>
                ...
                <h1 className="text-sm sm:text-base font-extrabold tracking-tight text-white flex items-center gap-1.5">
                  <span className="bg-gradient-to-r from-cyan-400 via-sky-200 to-amber-300 bg-clip-text text-transparent">
                    溶融亜鉛めっき「技術伝承AIバイブル」
                  </span>
                </h1>
              </div>
            ...
            {/* モバイル時のみ表示するクイック操作ボタン群 */}
            <div className="flex items-center gap-1.5 xl:hidden">
              <button
                onClick={() => setIsAiSettingsOpen(true)}
                className="p-1.5 rounded-lg bg-slate-800 border border-slate-700 text-cyan-300 hover:bg-slate-700"
                title="AI設定"
              >
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-lg bg-cyan-950/80 border border-cyan-500/60 text-cyan-300 text-[11px] font-bold"
              >
          ...
          {/* 中央：🌟 3大ナビゲーションタブ */}
          <div className="flex items-center justify-between sm:justify-center bg-slate-950/90 p-1 rounded-xl border border-slate-800 text-xs shadow-inner shrink-0">
            <button
          ...
          <div className="flex items-center justify-between xl:justify-end gap-3 shrink-0">
            {/* 収録進捗バー */}
            <div className="flex flex-col min-w-[140px] sm:min-w-[160px] bg-slate-950/60 xl:bg-transparent p-1 xl:p-0 rounded-lg border xl:border-none border-slate-800">
            ...
            <div className="hidden xl:flex items-center gap-2">
              <button
                onClick={() => setIsAiSettingsOpen(true)}
                className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-cyan-300 text-xs font-bold transition-all shadow-sm active:scale-95"
                title="AIモデル＆API設定"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-gradient-to-r from-cyan-500/20 to-blue-500/20 hover:from-cyan-500/30 hover:to-blue-500/30 border border-cyan-500/50 text-cyan-300 text-xs font-bold transition-all shadow-sm active:scale-95"
                title="操作マニュアルを開く"
              >
                <HelpCircle className="w-3.5 h-3.5 text-cyan-400" />
                <span>マニュアル</span>
              ...
              <button
                ...
                title="データ初期化"
                className="p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-400 hover:text-slate-200 transition-all"
              >
