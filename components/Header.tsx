      ...
      <header className="border-b border-slate-800 bg-slate-900/95 backdrop-blur-md sticky top-0 z-40 px-3 sm:px-4 lg:px-8 py-2.5 sm:py-3 shadow-lg shadow-black/20">
        <div className="max-w-[1750px] mx-auto flex flex-col md:flex-row items-stretch md:items-center justify-between gap-2.5 sm:gap-3">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {/* スマホ用 AI設定 ＆ 操作マニュアル ＆ リセットボタン */}
            <div className="flex items-center gap-1.5 md:hidden shrink-0">
              <button
                onClick={() => setIsAiSettingsOpen(true)}
                className="p-1.5 rounded-lg bg-cyan-950/80 border border-cyan-500/60 text-cyan-300"
                title="AIモデル＆API設定"
              >
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-lg bg-cyan-950/80 border border-cyan-500/60 text-cyan-300 text-[11px] font-bold shadow-sm"
                title="操作マニュアル"
              >
          ...
          <div className="flex items-center justify-between md:justify-end gap-2.5">
            <div className="flex flex-col flex-1 md:flex-initial md:min-w-[150px] bg-slate-950/60 md:bg-transparent p-1.5 md:p-0 rounded-lg md:rounded-none border md:border-none border-slate-800">
            ...
            {/* PC用 AI設定 ＆ 操作マニュアル ＆ リセットボタン */}
            <div className="hidden md:flex items-center gap-2 shrink-0">
              <button
                onClick={() => setIsAiSettingsOpen(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-cyan-300 text-xs font-bold transition-all shadow-sm active:scale-95 shrink-0"
